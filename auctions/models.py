...
class ClosedListing(models.Model):
    ...
    winner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='won_listings', null=True, blank=True, default=None)
    ...
    def __str__(self):
        return f"{self.title} (Closed) - {self.owner.username}"
